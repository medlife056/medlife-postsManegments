...
import 'package:MedLife/Screens/designer/cellScreen.dart';
import 'package:MedLife/Screens/designer/undesignerCounterScreen.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: GridView.count(
            ...
            mainAxisSpacing: isTablet ? widthScreen * 0.05 : 16,
            children: [
              _AnimatedCard(
                ...
                onTap: () {
                  ...
                  Get.to(() => UndesignerCounterScreen());
                },
              ),
              _AnimatedCard(
                icon: Icons.history,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Icon(
                widget.icon,
                size: isTablet ? heightScreen * 0.1 : 40,
                color: Colors.white,
              ),
              ...
              Text(
                widget.label,
                style: TextStyle(
                  fontSize: isTablet ? widthScreen * 0.05 : 16,
                  color: Colors.white,
